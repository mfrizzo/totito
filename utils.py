...
def decide_move(board: list, player_id: str):
    """
...
# Ganar :)
    ...
    if board [0][1] == player_id and board [2][1] == player_id and board[1][1] == "-":
        return [1,1]
...
# Bloquear mi enemy
    ...
    if board[2][1] == enemy and board [2][2] == enemy and board[2][0] == "-":
        return [2,0]
    ...
    if board[0][2] == enemy and board [1][1] == enemy and board[2][0] == "-":
        return [2,0]
    ...
    if board[0][2] == enemy and board [2][0] == enemy and board[1][1] == "-":
        return [0,0]
